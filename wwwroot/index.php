...
if($is_logged_in->isLoggedIn()){
    ...
    echo '<li>🌐 Support for Nether/Overworld coordinate scaling</li>';
    echo '</ul>';
    echo '</div>';
    echo '<div class="cta">';
    ...
    echo '</div>';
    echo '<p style="color: #7f8c8d; font-size: 0.9em;">Free to use • Save unlimited coordinate sets • No credit card required</p>';
    echo '</body>';
    echo '</html>';
    exit;
}
