...
current_x = end[0]
current_y += Y_INCREMENT
current_z = end[2]  # Should already be close
anchor5 = (int(current_x), int(current_y), int(current_z))
...
print(f"Z difference: {end[2] - after_curve4[2]}")
print()
